...
const Alchol = ({ loading, data, form }: TestPropTypes) => {
  const fieldName = "alchol_test_unit";
  const label = "Alcohol Test";
            ...
            <Row gutter={16}>
              <Col span={24}>
                <Form.Item
                  ...
                  rules={[
                    ...getVitalValidationRules('alchol_test'),
                    {
                      required: true,
                      message: 'Please enter alcohol test value'
                    }
                  ]}
